...
import { StyleSheet, View, Image, Text, TouchableOpacity, ScrollView, Dimensions , scrollViewEnabled} from 'react-native';
import { LinearGradient } from 'expo-linear-gradient';
import * as Location from 'expo-location';
import axios from 'axios';
import { Earth, Chart, Wind, Water, Rain, Clear, Clouds } from './icon';
import {
  LineChart,
